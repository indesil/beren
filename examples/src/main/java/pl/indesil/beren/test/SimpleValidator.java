...
import pl.indesil.beren.annotations.*;
import pl.indesil.beren.model.ValidationResults;
import pl.indesil.beren.test.model.*;
import pl.indesil.beren.test.model.customer.Gender;
...
public abstract class SimpleValidator {
   ...
   /*default void mojaWalidacja(Invoice invoice, ValidationResults validationResults) {
    ...
    //@Validator(register="pl.indesil.beren.custom.Validators")
